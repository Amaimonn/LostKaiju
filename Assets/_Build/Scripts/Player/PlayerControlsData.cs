...
[Serializable]
public class PlayerControlsData// : ICloneable
{
    ...
    // public object Clone()
    // {
    //     var clone = new BaseCharacterInputData()
    //     {
    //         walkSpeed = walkSpeed,
    //         frictionKoefficient = frictionKoefficient,
    ...
    //         jumpInputTimeBufferSize = jumpInputTimeBufferSize
    //     };
    //     return clone;
    // }
}
